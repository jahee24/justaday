...
LLM을 활용해 사용자의 감정을 분석하고, 즉각적인 피드백을 제공함으로써 '기록하는 즐거움'과 '심리적 케어'를 동시에 제공하고자 했습니다.
...
- **문제**: Gemini API 호출 및 응답 생성에 평균 5~7초가 소요되어, 사용자가 '제출' 버튼을 누른 후 로그인이 튕기는 문제가 발생했습니다.
